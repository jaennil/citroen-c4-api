...
**Ссылки @P в этой сборке битые, проверено на пяти кодах.** P0116 ведёт на текст про
блокировку гидротрансформатора, B1137 на "transfer pump". GPC.FDB и словари собраны
из разных обновлений DiagBox. Поэтому рабочий источник один - inline-текст в DSD.FDB.
...
Коды BSI вида B1003/B1137/B1228 не закрыты: в DSD у них вместо описания "Group_1", а
@P-ссылки битые. Это ограничение образа, не метода.
