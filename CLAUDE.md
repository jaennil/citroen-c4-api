...
`local/docker-compose.yml` поднимает на ноутбуке Postgres (127.0.0.1:5433, car/car) и
Grafana (порт 3000, анонимный просмотр, алерты выключены). Дашборд тот же самый JSON из
...
`c4-telemetry`. С телефона: `http://<ip ноутбука в хотспоте>:3000/d/citroen-c4`.
