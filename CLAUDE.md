...
Расписание после добавления: 83 вылазки за 30 минут при вместимости 90 (`MIN_GAP` 20 с),
поток BSI простаивает ~11 % времени. Юнит службы не менялся, так что новый код подхватится
