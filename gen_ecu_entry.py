...
def main():
    ...
    # Пусто. Здесь стояло {0x6A8: "1003"} - попытка загнать двигатель в UDS, потому
    # что каталог VD46 читается по 22 D4xx. Проверено на машине: с UDS-входом блок
    # МОЛЧИТ, с KWP-входом (финал 81) отвечает. Значит наш V46 - KWP-вариант, и
    # каталог нужен из семейства V46_32, а не VD46.
    WANT_FINAL = {}
    for s in seqs:
